...
def live_three_day_html() -> str:
    """Active plan: Spain loop meteo-aware (app. temp < 25 °C), back Teià Sat 22."""
    return """
<section class="section live-plan" id="plan-rapido">
<div class="live-title"><span>Plan activo</span><h2>Domingo 16 → sábado 22 · sensación &lt; 25 °C · Teià</h2></div>
<div class="warn"><strong>Regla calor:</strong> fuera de la furgoneta solo si la <strong>sensación térmica</strong> (temp + humedad, Open-Meteo <em>apparent_temperature</em>) queda <strong>por debajo de 25 °C</strong>. Si sube → sombra / siesta / conducir con AC. Perras siempre con correa. No Parrizal de Beceite si ban de perros. Irati: parking de día; dormid en pueblo.</div>
<div class="callout"><strong>Meteo (Open-Meteo, Europa/Madrid · lectura ~10 ago):</strong> 16–17 Albarracín/Morella calurosos de tarde (sens. ~28–30 °C desde ~11:00). <strong>18–19</strong> Teruel–Ports frescos (sens. máx ~19–23 °C) — mejores días de hike. Navarra 18–19: lluvia fuerte (evitad Irati). <strong>20 Irati</strong> seco y fresco (sens. máx ~16 °C) — día estrella. 21 Irati OK hasta ~13–14 h; 22 salida temprano a Teià.</div>

<article class="card prose">
<h3>Domingo 16 · Teià → Albarracín</h3>
<div class="meta"><span class="tag">~5,5–6 h</span><span class="tag">solo conducción / tarde</span><span class="tag">sens. tarde ~29 °C · no hike</span></div>
<ol>
<li>Salida temprano de Teià (el Ebro y la costa ya van húmedo-calurosos).</li>
...
<li>Llegada: <strong>sin ruta</strong>. Sombra, agua, paseo corto pueblo solo si la sensación ya baja (noche / muy tarde).</li>
</ol>
<div class="trail"><h4>Dormir</h4>
<p><strong>Plan A:</strong> P4N Tejería · Albarracín · <a href="https://park4night.com/es/place/390083" target="_blank" rel="noopener">#390083</a>.</p>
<p><strong>Plan B:</strong> <a href="https://www.campingalbarracin.com/" target="_blank" rel="noopener">Camping Ciudad de Albarracín</a> — sombra y duchas.</p>
</div>
</article>

<article class="card prose">
<h3>Lunes 17 · Rodeno ventana corta</h3>
<div class="meta"><span class="tag">hike 7:00–10:00</span><span class="tag">sens. ≥25 °C desde ~11:00</span><span class="tag">noche Albarracín</span></div>
<ul>
<li><strong>7:00–10:00:</strong> Pinares de Rodeno (sombra de pino). Cortad al llegar a sensación 25 °C — tip. ~11:00.</li>
<li><strong>11:00–19:00:</strong> siesta / sombra / pueblo con paradas en fresco. No forcéis.</li>
<li>Perras atadas. Llevad agua de sobra.</li>
</ul>
<div class="btns">
...
<article class="card prose">
<h3>Martes 18 · Día fresco · Rodeno/sierra → Morella</h3>
<div class="meta"><span class="tag">sens. máx ~20 °C</span><span class="tag">todo el día OK hike</span><span class="tag">traslado ~2,5–3 h</span></div>
<ol>
<li><strong>Mañana:</strong> segundo Rodeno o sierra suave (Tramacastilla) — día bueno de verdad.</li>
<li>Mediodía/tarde: <a href="https://www.google.com/maps/dir/?api=1&amp;origin=40.407,-1.444&amp;destination=40.619,-0.100&amp;travelmode=driving" target="_blank" rel="noopener">Google · Albarracín → Morella</a> (también fresco en Morella).</li>
<li>Atardecer: vistas castillo / primer paseo.</li>
</ol>
<div class="warn">No subáis aún a Irati: en Ochagavía/Casas de Irati el 18–19 hay <strong>lluvia fuerte</strong> (≈13–34 mm) y frío húmedo.</div>
<div class="trail"><h4>Dormir Morella</h4>
<p><strong>Camping-Car Park Morella</strong> · <a href="https://park4night.com/es/place/6766" target="_blank" rel="noopener">P4N #6766</a>.</p>
</div>
</article>

<article class="card prose">
<h3>Miércoles 19 · Morella + Ports (día estrella sur)</h3>
<div class="meta"><span class="tag">sens. máx ~19–23 °C</span><span class="tag">Ports OK todo el día</span><span class="tag">noche Morella</span></div>
<ul>
<li>Murallas / casco temprano; luego <strong>Ports de Morella / Vilafranca</strong> (bosque, sombra).</li>
<li>Evitad <strong>Parrizal de Beceite</strong> si ban de perros.</li>
<li>Sensación cómoda todo el día — podéis alargar la ruta sin calor.</li>
</ul>
<div class="btns">
...
<article class="card prose">
<h3>Jueves 20 · Traslado + Irati (día estrella Navarra)</h3>
<div class="meta"><span class="tag">Irati seco · sens. máx ~16 °C</span><span class="tag">salida Morella ~8:00</span><span class="tag">noche Ochagavía</span></div>
<ol>
<li><strong>Opción A (recomendada):</strong> salida ~8:00 Morella → Ochagavía (~5 h). Llegada ~13:00 → ruta Irati tarde (sensación baja, seco).</li>
<li><strong>Opción B:</strong> Penyagolosa solo 7:00–9:30 (sens. OK) y luego norte — no tardéis o perdéis la tarde fresca en Irati.</li>
<li><a href="https://www.google.com/maps/dir/?api=1&amp;origin=40.619,-0.100&amp;destination=42.908,-1.091&amp;travelmode=driving" target="_blank" rel="noopener">Google · Morella → Ochagavía</a>.</li>
</ol>
<div class="warn">Irati: perros <strong>siempre atados</strong>. Parkings oficiales de día; dormid en pueblo, no en Casas de Irati.</div>
<div class="trail"><h4>Dormir</h4>
<p><strong>Ochagavía</strong> · <a href="https://park4night.com/es/place/298598" target="_blank" rel="noopener">P4N #298598</a> · o camping Osate / Roncal (sombra + duchas).</p>
</div>
<div class="btns">
<a class="btn btn-w" href="https://turismoselvadeirati.com/selva-de-irati/" target="_blank" rel="noopener">Turismo Selva de Irati</a>
<a class="btn btn-g" href="https://www.google.com/maps/dir/?api=1&amp;origin=42.908,-1.091&amp;destination=42.990,-1.120&amp;travelmode=driving" target="_blank" rel="noopener">Google · Casas de Irati</a>
</div>
</article>

<article class="card prose">
<h3>Viernes 21 · Irati mañana · corte a las 13–14 h</h3>
<div class="meta"><span class="tag">hike 7:00–13:00</span><span class="tag">sens. ≥25 °C desde ~13–14 h</span><span class="tag">noche Ochagavía</span></div>
<ul>
<li>Segunda ruta fácil/media (o la principal si el jueves solo llegasteis).</li>
<li><strong>Parad a las 13–14 h</strong> cuando la sensación se acerque a 25 °C (Casas de Irati tip. AppMax ~26–27 °C).</li>
<li>Tarde: sombra pueblo / siesta. No forcéis hayedo a pleno sol.</li>
</ul>
</article>

<article class="card prose">
<h3>Sábado 22 · Ochagavía → Teià</h3>
<div class="meta"><span class="tag">salida ~8:30–9:00</span><span class="tag">~5–5,5 h</span><span class="tag">Teià húmedo-caluroso · solo coche</span></div>
<ol>
<li>Café corto. Sin hike (en valle la sensación sube hacia mediodía).</li>
<li><a href="https://www.google.com/maps/dir/?api=1&amp;origin=42.908,-1.091&amp;destination=41.498,2.319&amp;travelmode=driving" target="_blank" rel="noopener">Google · Ochagavía → Teià</a>.</li>
<li>Llegada tarde a casa.</li>
</ol>
</article>

<article class="card prose">
<h3>Resumen · ventanas sensación &lt; 25 °C</h3>
<ul>
<li><strong>16</strong> solo traslado · tarde caliente</li>
<li><strong>17</strong> Rodeno 7–10 h · resto sombra</li>
<li><strong>18–19</strong> mejores días hike (Alb → Morella / Ports)</li>
<li><strong>20</strong> traslado + Irati tarde (día estrella Navarra, seco)</li>
<li><strong>21</strong> Irati hasta 13–14 h</li>
<li><strong>22</strong> Teià temprano</li>
</ul>
<p>Revisad Open-Meteo a las 7:00 cada mañana; si la sensación ya va a 25 °C, acortad.</p>
</article>
</section>
"""
...
<li><strong>Horario calor:</strong> fuera solo si sensación térmica &lt; 25 °C (Open-Meteo apparent). Tip. hike 7:00–corte · sombra el resto · paseo corto al fresco.</li>
</ul>
</div></section>
""")
